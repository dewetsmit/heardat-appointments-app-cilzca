...
// Heardat brand colors (based on logo)
export const heardatColors = {
  primary: "#4A90E2", // Blue from logo
  secondary: "#50C878", // Green accent
  accent: "#FF6B6B", // Red for alerts/cancellations
  lightBlue: "#E8F4F8",
  darkBlue: "#2C5F8D",
};
...
export const Colors = {
  light: {
    text: "#11181C",
    background: "#F8F9FA",
    tint: heardatColors.primary,
    icon: "#687076",
    tabIconDefault: "#687076",
    tabIconSelected: heardatColors.primary,
    card: "#FFFFFF",
    border: "#E5E7EB",
    success: heardatColors.secondary,
    error: heardatColors.accent,
    warning: "#FFA500",
  },
  dark: {
    text: "#ECEDEE",
